      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: TemaAplikasi.sukses.withValues(alpha: 0.06),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.verified,
                          color: TemaAplikasi.sukses, size: 28),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                'Ukuran: ${item['ukuran'] ?? '-'} · Jumlah: ${item['jumlah'] ?? 1} ${item['satuan'] ?? 'pcs'}',
                                style: TextStyle(
                                  fontSize: 12,
